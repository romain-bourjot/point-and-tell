...
It adds no dependency to your app and writes nothing into your repository.
...
Start the app however you normally do, then ask Claude for a live pass in
whatever words come to you: *let me point at things*, *take my notes from the
browser*, *a batch is waiting on Go*. It boots the helper and hands you an
install page: drag the button to your bookmarks bar once, click it on any
screen, and the bar appears.
...
That descriptor is what makes a note usable. *This button is too wide* is only a
complaint about pixels until the test id, the route and the measurements arrive
next to it.
